...
//var db = mongojs("SD");
var db = mongojs("mongodb+srv://guillermo:1123581321@mycluster.bscyw.mongodb.net/hoteles?retryWrites=true&w=majority")
...
https.createServer(OPTIONS_HTTPS, app).listen(port, () => {
    console.log('Secure WS API REST CRUD con DB para hoteles ejecutandose en https://localhost:' + port + '/api/:coleccion/:id');
});